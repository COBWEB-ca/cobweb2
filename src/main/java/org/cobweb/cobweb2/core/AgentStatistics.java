...
public class AgentStatistics implements Serializable {
	...
	public AgentStatistics(int num, int type, long birth, AgentStatistics p1, AgentStatistics p2) {
		this.type = type;
		id = num;
		birthTick = birth;
	...
	public AgentStatistics(int num, int type, long birth, AgentStatistics p1) {
		this.type = type;
		id = num;
		birthTick = birth;
		parent1 = p1 != null ? p1.id : -1;
	...
	public AgentStatistics(int num, int type, long birth) {
		this.type = type;
		id = num;
		birthTick = birth;
	}
