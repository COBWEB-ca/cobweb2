...
public class ComplexAgentLearning extends ComplexAgent {
	...
	@Override
	public void init(int agentT, ComplexAgentParams agentData, Direction facingDirection,
			Location pos) {
		super.init(agentT, agentData, facingDirection, pos);
		throw new IllegalArgumentException("Cannot initialize ComplexAgentLearning without LearningAgentParams");
	}

	public void init(int agentType, Location pos, ComplexAgentParams agentData, LearningAgentParams lAgentData) {
		super.init(agentType, pos, agentData);
