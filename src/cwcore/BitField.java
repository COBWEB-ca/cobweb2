...
public class BitField {
	...
	/**
	 * The add method shifts the current value left according to the second parameter to make room for that many bits,
	 * then places the bits specified by the first parameter into the newly freed slots
	 */
